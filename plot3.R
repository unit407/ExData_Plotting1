...
## Convert the three variables to numeric
correctedTableFinal <- transform(smallTable, Sub_metering_1 = as.numeric(Sub_metering_1), 
...
plot(date_time, correctedTableFinal$Sub_metering_1, type="l", ylab="Energy Submetering", xlab="")
